# -*- encoding: utf-8 -*-
# stub: i18n-tasks 1.0.4 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :add_runtime_dependency then
    ...
    s.add_runtime_dependency(%q<better_html>.freeze, ["~> 1.0"])
    ...
    s.add_development_dependency(%q<rubocop>.freeze, ["~> 1.6.1"])
    ...
    s.add_dependency(%q<better_html>.freeze, ["~> 1.0"])
    ...
    s.add_dependency(%q<bundler>.freeze, ["~> 2.0", ">= 2.0.1"])
    s.add_dependency(%q<rake>.freeze, [">= 0"])
    s.add_dependency(%q<rspec>.freeze, ["~> 3.3"])
    s.add_dependency(%q<rubocop>.freeze, ["~> 1.6.1"])
